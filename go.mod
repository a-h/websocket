module github.com/a-h/websocket
...
require (
	...
	github.com/aws/aws-cdk-go/awscdkapigatewayv2integrationsalpha/v2 v2.79.1-alpha.0
	github.com/aws/aws-cdk-go/awscdklambdagoalpha/v2 v2.79.1-alpha.0
